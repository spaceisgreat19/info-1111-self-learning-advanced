...
function normalizePriority(p: unknown): Priority {
  ...
  return validPriorities.includes(formatted as Priority) ? formatted as Priority : 'Medium';
}
    ...
    switch (req.method) {
      case 'POST': {
        ...
        await client.execute({
          ...
          args: [apartment, issue, completed ? 1 : 0, normalizedPriority, date] as SqlParam[]
        });
